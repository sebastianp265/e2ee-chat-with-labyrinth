...
export async function kdf_one_key(ikm: Uint8Array, salt: Uint8Array, info: Uint8Array, key_length: number = KEY_LENGTH_BYTES) {
    return hkdfSHA256(ikm, salt, info, key_length)
}

export async function kdf_two_keys(ikm: Uint8Array, salt: Uint8Array, info: Uint8Array, first_key_length: number = KEY_LENGTH_BYTES, second_key_length: number = KEY_LENGTH_BYTES) {
...
async function hkdfSHA256(ikm: Uint8Array, salt: Uint8Array, info: Uint8Array, keyLength: number): Promise<Uint8Array> {
