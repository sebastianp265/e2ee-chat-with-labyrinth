...
export class CommonPublicKeyBundle {
    ...
    public serialize(): CommonPublicKeyBundleSerialized {
        return {
            ...
            epochStorageKeySig: BytesSerializer.serialize(this.epochStorageKeySig),
        }
    }

    public static deserialize(devicePublicKeyBundleSerialized: CommonPublicKeyBundleSerialized): CommonPublicKeyBundle {
        const {
            deviceKeyPub,
            epochStorageKeyPub,
            epochStorageKeySig,
        ...
        return new CommonPublicKeyBundle(
            ...
            BytesSerializer.deserialize(epochStorageKeySig),
        )
    }
