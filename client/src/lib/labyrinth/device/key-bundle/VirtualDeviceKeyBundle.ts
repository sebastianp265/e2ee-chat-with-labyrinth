...
export class VirtualDeviceKeyBundle {
    ...
    public constructor(priv: VirtualDevicePrivateKeyBundle, pub: VirtualDevicePublicKeyBundle) {
        this.priv = priv
        this.pub = pub
    }
    ...
    public static generate(): VirtualDeviceKeyBundle {
        ...
        return new VirtualDeviceKeyBundle(
            priv,
...
export type VirtualDevicePublicKeyBundleSerialized = CommonPublicKeyBundleSerialized
